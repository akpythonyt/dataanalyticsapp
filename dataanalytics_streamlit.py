...
batsman=pd.read_excel('https://raw.githubusercontent.com/akpythonyt/Datasets/main/Top_100_batsman.csv')
...
Bowlers=pd.read_excel('https://raw.githubusercontent.com/akpythonyt/Datasets/main/Top_100_bowlers.csv')
