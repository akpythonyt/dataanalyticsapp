...
Matches=pd.read_csv(r'https://github.com/akpythonyt/dataanalyticsapp/blob/main/matches.csv')
...
Bowlers=pd.read_excel(r'https://github.com/akpythonyt/dataanalyticsapp/blob/main/Top_100_bowlers.xlsx')
